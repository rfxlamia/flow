...
2. **Find screenwriter tracking file:** Extract `tracking_file` from stage 03
3. **Load tracking YAML:** Read the screenwriter-{timestamp}.yaml file
4. **Extract data:** Get screenplay_file, scene_count, location_list, prop_list
5. **Load screenplay:** Read the XML-tagged screenplay markdown
...
**File:** `outputs/validated-{timestamp}.md`
