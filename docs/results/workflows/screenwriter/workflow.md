...
2. **Find storyteller tracking file:** Extract `tracking_file` from stage 02
3. **Load tracking YAML:** Read the storyteller-{timestamp}.yaml file
4. **Extract data:** Get scene_breakdown_file, characters, locations, emotional_arc
5. **Load scene breakdown:** Read the scenes markdown from storyteller
...
**File:** `outputs/screenplay-{timestamp}.md`
