...
**File:** `outputs/diverse-content-gen-{timestamp}.md`
...
**File path:** `{project-root}/.bmad/creative-studio/workflows/diverse-content-gen/outputs/content-{timestamp}.md`
...
Use the **Edit** tool to update the pipeline state file.

**File to edit:** `{project-root}/.bmad/creative-studio/_state/creative-pipeline-state.yaml`
...
```yaml
  - stage: 01-diverse-content-gen
    status: completed
    output_file: "workflows/diverse-content-gen/outputs/content-{timestamp}.md"
...
```yaml
# Quick Access
current_stage: "02-storyteller"
last_output: "workflows/diverse-content-gen/outputs/content-{timestamp}.md"
