...
**Generated:** 2025-12-15T00-39-20Z
...
### Characters Found (2)
- [ ] Content Creator - NEEDS DESCRIPTION
- [ ] Claude - NEEDS DESCRIPTION

### Locations Found (4)
- [ ] Aesthetic Desk Workspace - NEEDS REFERENCE PROMPTS
- [ ] Transitioning From Staged Setup To Real Workspace - NEEDS REFERENCE PROMPTS
- [ ] Real Workspace - NEEDS REFERENCE PROMPTS
- [ ] Real Workspace With Close-Ups - NEEDS REFERENCE PROMPTS
...
```
Ditemukan 2 karakter: Content Creator, Claude
...
### Location: Transitioning From Staged Setup To Real Workspace
**Status:** [ ] Reference prompts generated
...
### Location: Real Workspace With Close-Ups
**Status:** [ ] Reference prompts generated
...
### Generation Progress:
- [ ] Character reference prompts (2 characters × 6 prompts)
- [ ] Location reference prompts (4 locations × 3 prompts)
- [ ] Scene keyframes (10 scenes × 1-2 prompts each)
...
5. Output final file: `imagine-prompts-2025-12-15T00-39-20Z.md`
